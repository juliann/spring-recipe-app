...
CREATE USER 'spring_recipe_dev_user'@'localhost' IDENTIFIED BY 'Pa$$w0rd';
CREATE USER 'spring_recipe_prod_user'@'localhost' IDENTIFIED BY 'Pa$$w0rd';
CREATE USER 'spring_recipe_dev_user'@'%' IDENTIFIED BY 'Pa$$w0rd';
CREATE USER 'spring_recipe_prod_user'@'%' IDENTIFIED BY 'Pa$$w0rd';
